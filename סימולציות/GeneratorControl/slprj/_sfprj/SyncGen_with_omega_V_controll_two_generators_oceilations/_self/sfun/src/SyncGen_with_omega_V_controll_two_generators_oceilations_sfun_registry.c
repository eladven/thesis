  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_SyncGen_with_omega_V_controll_two_generators_oceilations_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName,
             "SyncGen_with_omega_V_controll_two_generators_oceilations") == 0) {
...
extern void SyncGen_with_omega_V_controll_two_generators_oceilations_terminator
  (void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    SyncGen_with_omega_V_controll_two_generators_oceilations_terminator();
...
extern void SyncGen_with_omega_V_controll_two_generators_oceilations_initializer
  (void);
...
extern void
  SyncGen_with_omega_V_controll_two_generators_oceilations_debug_initialize(
    struct SfDebugInstanceStruct*);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    SyncGen_with_omega_V_controll_two_generators_oceilations_initializer();
    if (!simModeIsRTWGen) {
