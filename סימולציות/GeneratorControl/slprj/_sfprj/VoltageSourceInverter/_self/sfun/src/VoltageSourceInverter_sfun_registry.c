#include "VoltageSourceInverter_sfun.h"
#include "sfcdebug.h"
...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_VoltageSourceInverter_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PartTransformation_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_VoltageSourceInverter_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_PartTransformation_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_VoltageSourceInverter_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PartTransformation_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "VoltageSourceInverter") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_VoltageSourceInverter_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "PartTransformation") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PartTransformation_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_VoltageSourceInverter_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PartTransformation_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "VoltageSourceInverter") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_VoltageSourceInverter_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "PartTransformation") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PartTransformation_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_VoltageSourceInverter_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PartTransformation_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "VoltageSourceInverter") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_VoltageSourceInverter_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
  ...
  if (strcmp(machineName, "PartTransformation") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_PartTransformation_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_VoltageSourceInverter_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_PartTransformation_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"VoltageSourceInverter")) {
    return(sf_VoltageSourceInverter_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }

  if (!strcmp(machineName,"PartTransformation")) {
    return(sf_PartTransformation_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void VoltageSourceInverter_terminator(void);
extern void PartTransformation_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    VoltageSourceInverter_terminator();
    PartTransformation_terminator();
...
extern void VoltageSourceInverter_initializer(void);
extern void PartTransformation_initializer(void);
extern void VoltageSourceInverter_register_exported_symbols(SimStruct* S);
extern void PartTransformation_register_exported_symbols(SimStruct* S);
extern void VoltageSourceInverter_debug_initialize(struct SfDebugInstanceStruct*);
extern void PartTransformation_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  VoltageSourceInverter_register_exported_symbols(S);
  PartTransformation_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      VoltageSourceInverter_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    VoltageSourceInverter_initializer();
    if (!simModeIsRTWGen) {
      PartTransformation_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    PartTransformation_initializer();
  }
