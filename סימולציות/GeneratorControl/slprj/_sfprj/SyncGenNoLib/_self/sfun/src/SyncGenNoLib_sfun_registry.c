...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_SyncGenNoLib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_SyncGenLib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SyncGenNoLib_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_SyncGenNoLib_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "SyncGenNoLib") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SyncGenNoLib_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_SyncGenNoLib_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "SyncGenNoLib") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SyncGenNoLib_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_SyncGenNoLib_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "SyncGenNoLib") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_SyncGenNoLib_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_SyncGenNoLib_method_dispatcher(SimStruct *S, unsigned int
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"SyncGenNoLib")) {
    return(sf_SyncGenNoLib_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void SyncGenNoLib_terminator(void);
...
extern void SyncGenNoLib_initializer(void);
extern void SyncGenLib_initializer(void);
extern void SyncGenNoLib_register_exported_symbols(SimStruct* S);
extern void SyncGenLib_register_exported_symbols(SimStruct* S);
extern void SyncGenNoLib_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  SyncGenNoLib_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      SyncGenNoLib_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    SyncGenNoLib_initializer();
    if (!simModeIsRTWGen) {
