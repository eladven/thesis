...
MACHINE     = two_generators_grid
TARGET      = sfun
CHART_SRCS 	= 
MACHINE_SRC	= two_generators_grid_sfun.c
MACHINE_REG = two_generators_grid_sfun_registry.c
MAKEFILE    = two_generators_grid_sfun.mak
...
OBJLIST_FILE = two_generators_grid_sfun.mol
...
AUX_LNK_OBJS =     
USER_LIBS = 
LINK_MACHINE_LIBS = "C:\Users\USER\Desktop\תזה\סימולציות\GeneratorControl\slprj\_sfprj\two_generators_grid\SyncGenLib\sfun\src\SyncGenLib_sfun.lib" "C:\Users\USER\Desktop\תזה\סימולציות\GeneratorControl\slprj\_sfprj\two_generators_grid\ControledSyncGenLib\sfun\src\ControledSyncGenLib_sfun.lib" 
