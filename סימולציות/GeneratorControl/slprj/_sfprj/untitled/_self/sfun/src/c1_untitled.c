  ...
  const mxArray *c1_st)
{
  ...
  *c1_c = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
  ...
  chartInstance->c1_is_active_c1_untitled = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "is_active_c1_untitled");
  sf_mex_destroy(&c1_u);
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[1],M[6],T\"b\",},{M[1],M[7],T\"c\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
