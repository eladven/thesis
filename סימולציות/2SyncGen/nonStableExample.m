...
eig_eq_d_pi = eig(double(T3))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calculation of the stability of reduced model 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

A_hat = [-Dp/J + Rtot*mif^2/(J*(Rtot^2-Rl^2)), -Rl*mif^2/(J*(Rtot^2-Rl^2));
    -Rl*mif^2/(J*(Rtot^2-Rl^2)),-Dp/J + Rtot*mif^2/(J*(Rtot^2-Rl^2))]