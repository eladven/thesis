function h = initValuesVivek(Rl_param,w0_param,Tm_param,useW0param)

% Eitan one generator with nominal power of 5kW V = 330 [v] (phase to
% ground)
global Ls Lg Ltot J Rs w0 Dp mif Rl Rtot RT Tm iq0 id0 
Ls = 27.5*10^-3 %[H] - Eitan  %% The value for getting unstability 0.1*10^-3;
Lg = 0;
Ltot = Lg+Ls;
J = 20; % [kg*Sec]  - Eitan
