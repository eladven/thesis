...
\begin{theorem}
If a  system  has form \eqref{eq:systemForm}, and it satisfies the following conditions: 
\begin{enumerate}
\item
...
This theorem is one of the main results of \cite{AndrieuJayawardhanaPraly}. 
