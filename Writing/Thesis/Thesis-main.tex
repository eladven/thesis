...
\centering \includegraphics[width=12cm]{full_circuit_with_2_SGs}
...
where 
$$ \begin{aligned}
&A_e\left(e,x\right)  = \\ & \left[\begin{array}{cccc}
...
equilibrium point $\left[z^e\ z^e \ \delta^e \right]^\top$. (The parameters for this simulations can be found at the appendix,
table \ref{table:5KWSG}).
...
are (he parameters for the two simulations in this subsection can be found at the appendix,
...
not hold. (The parameters for this simulations can be found at the appendix,
...
\bibitem{GreenProdanovic:07}
T.~Green and M.~Prodanovic, \m Control of inverter-based micro-grids,  {\em Electric Power Systems Research}, vol.~77, 2007, pp.~1204-1213.
...
\bibitem{shafiee2016multi} Q.~Shafiee,  V.~Nasirian,  J.C.~Vasquez, J.M.~Guerrero and A.~Davoudi. \m A Multi-Functional Fully Distributed Control Framework for AC Microgrids, {\em 
 IEEE Transactions on Smart Grid}, 2016.

 \bibitem{schiffer2016survey} J.~Schiffer, D.~Zonetti, R.~Ortega, A.~Stankovi{\'c},  T.~Sezi  and J.~Raisch. \m A survey on modeling of microgrids-From fundamental physics to phasors and voltage sources, {\em 
