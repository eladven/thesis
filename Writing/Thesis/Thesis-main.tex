...
In this section we develop a model for a microgid composed of two identical SGs connected connected to a resistive load, assuming constant field current (see Figure \ref{fig:TICSGThreePhase}).
